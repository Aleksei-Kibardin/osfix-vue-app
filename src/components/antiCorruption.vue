  ...
  <div class="wrap-content">
    <div class="content">
      <div class="wrap-title">
        ...
        <h1>Противодействеие корупции</h1>
      </div>
      <h3>Обратная связь для сообщений о фактах коррупции</h3>
      <p>
        Если Вам стало известно о совершении (приготовлении) коррупционных
        правонарушений или каких - либо действий, нарушающих имущественные и
        иные права и законные интересы Штамповочного завода "Первый завод", Вы
        можете сообщить об этом, воспользовавшись специализированными каналами
        связи, включающими:
      </p>
      <ul>
        ...
        <li>
          для почтовых отправлений: , Россия, Санкт - Петербург, Лиговский
          пр-кт, 52 лит О, Заместителю директора по безопасности "Первый завод".
        </li>
      </ul>
      Документы:
    </div>
